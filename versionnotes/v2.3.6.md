...
- advanced support for JDBC connections, including support for multiple databases and multiple connection strings.
- improved handling of JDBC connection strings for Neon Postgres and other Cloud SQL providers.
